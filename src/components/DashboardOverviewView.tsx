            ...
            <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
                <div className="max-w-[1500px] space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                            <div className="text-[11px] text-[#676879] uppercase tracking-wider font-semibold">ใกล้ถึงกำหนด (48 ชม.)</div>
                            <div className="text-3xl font-black text-[#fdab3d] mt-1">{metrics.dueSoonTasks.length}</div>
                        </div>
                        <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                            <div className="text-[11px] text-[#676879] uppercase tracking-wider font-semibold">ยังไม่มอบหมาย</div>
                            <div className="text-3xl font-black text-[#579bfc] mt-1">{metrics.unassignedTasks.length}</div>
                        </div>
                        <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                            <div className="text-[11px] text-[#676879] uppercase tracking-wider font-semibold">สมาชิกที่งานล้น</div>
                        ...
                        <div className="bg-white rounded-xl border border-[#d0d4e4] overflow-hidden">
                            <div className="px-5 py-4 border-b border-[#e6e9ef] flex flex-wrap items-center justify-between gap-2">
                                <div>
                                    ...
                                    <p className="text-[12px] text-[#676879]">เทียบชั่วโมงความจุกับชั่วโมงที่ได้รับมอบหมาย</p>
                                </div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                                <div className="flex items-center gap-2 text-[14px] font-bold text-[#323338]">
                                    <AlertTriangle className="w-4 h-4 text-[#e2445c]" /> จุดเร่งด่วน
                                </div>
                                <div className="mt-3 space-y-2">
                                    {metrics.overdueTasks.slice(0, 5).map((task) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-[11px] text-[#e2445c] mt-1">กำหนดส่ง: {task.planEndDate}</div>
                                        </Link>
                                    ))}
                            ...
                            <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                                <div className="flex items-center gap-2 text-[14px] font-bold text-[#323338]">
                                    <Clock3 className="w-4 h-4 text-[#fdab3d]" /> ใกล้ถึงกำหนด
                                </div>
                                <div className="mt-3 space-y-2">
                                    {metrics.dueSoonTasks.slice(0, 5).map((task) => (
                                        ...
                                        >
                                            <div className="text-[12px] font-semibold text-[#323338] truncate">{task.name}</div>
                                            <div className="text-[11px] text-[#fdab3d] mt-1">กำหนดส่ง: {task.planEndDate}</div>
                                        </Link>
                                    ))}
                            ...
                            <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                                ...
                                <div className="mt-3 text-[12px] text-[#676879]">{metrics.unassignedTasks.length} งานที่ยังต้องระบุผู้รับผิดชอบ</div>
                            </div>

                            <div className="bg-white rounded-xl border border-[#d0d4e4] p-4">
                                <div className="flex items-center gap-2 text-[14px] font-bold text-[#323338]">
                                    <UsersRound className="w-4 h-4 text-[#323338]" /> เตือนความจุงาน
                                </div>
                                <div className="mt-3 text-[12px] text-[#676879]">
                                    {metrics.overloadedMembers.length > 0
                                        ? `${metrics.overloadedMembers.length} คน มีภาระงานเกิน 100% ของความจุ`
                                        : 'ทุกคนยังมีภาระงานอยู่ในขอบเขตความจุ'}
                                </div>
                            </div>
                        </div>
                    </div>
