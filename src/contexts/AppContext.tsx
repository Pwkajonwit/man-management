...
const DEFAULT_NOTIFICATION_SETTINGS: NotificationSettings = {
    ...
    adminReportProjectSummaryEnabled: true,
    adminReportTodayTeamLoadEnabled: false,
    adminReportCompletedLast2DaysEnabled: false,
...
export function AppProvider({ children }: { children: ReactNode }) {
    ...
    }, [loadLocalFallback, authLoading, user]);
    ...
    const handleAddItem = useCallback(async (category: string) => {
        const projId = activeProjectId || 'proj-1';
        const nextOrder =
            tasks
    ...
    }, [activeProjectId, dataSource, tasks]);
